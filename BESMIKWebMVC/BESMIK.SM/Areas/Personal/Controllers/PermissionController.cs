...
namespace BESMIK.SM.Areas.Personal.Controllers
{
    ...
    public class PermissionController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _httpClient.GetFromJsonAsync<AppUserViewModel>("https://besmikapi20240825115620.azurewebsites.net/api/AppUser/GetUserInfo/" + user));
        }
        ...
        public async Task<IActionResult> PermissionList()
        {
                ...
                var permission = await _httpClient.GetFromJsonAsync<List<PermissionViewModel>>($"https://besmikapi20240825115620.azurewebsites.net/api/Permission/PermissionList");
        ...
        public async Task<IActionResult> PermissionAdd(PermissionViewModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClient.PostAsJsonAsync("https://besmikapi20240825115620.azurewebsites.net/api/Permission/PermissionAdd", model);
        ...
        public async Task<IActionResult> PermissionDelete(int id)
        {
            try
            {
                var response = await _httpClient.DeleteAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Permission/PermissionDelete{id}");
                if (response.IsSuccessStatusCode)
                {
                    return RedirectToAction("PermissionList");
                }
