...
namespace BESMIK.SM.Areas.Personal.Controllers
{
    ...
    public class SpendingController : Controller
    {
        ...
        public async Task<IActionResult> SpendingList()
        {
            ...
            var request = await _httpClient.GetFromJsonAsync<AppUserViewModel>("https://besmikapi20240825115620.azurewebsites.net/api/UserInfo/GetUserInfo/" + user);

            var spendings = await _httpClient.GetFromJsonAsync<List<SpendingViewModel>>($"https://besmikapi20240825115620.azurewebsites.net/api/Spending/SpendingList");
        ...
        public async Task<IActionResult> SpendingAdd(SpendingViewModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClient.PostAsJsonAsync<SpendingViewModel>("https://besmikapi20240825115620.azurewebsites.net/api/Spending/SpendingAdd", model);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                var response = await _httpClient.DeleteAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Spending/Delete/{id}");
        ...
        {
            var response = await _httpClient.GetAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Spending/GetSpending/{id}");
    ...
    .ToList();
        ...
        public async Task<IActionResult> SpendingEdit(SpendingViewModel model)
        {
            ...
            var user = HttpContext.User.Identity.Name;
            var request = await _httpClient.GetFromJsonAsync<AppUserViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/AppUser/GetUserInfo/{user}");
            if (request == null)
            {
            ...
            try
            {
                ...
                {
                    var spendingfilee = await _httpClient.GetFromJsonAsync<SpendingViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/Spending/GetSpending/{model.Id}");
                ...
                var response = await _httpClient.PutAsJsonAsync<SpendingViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/Spending/EditSpending/{model.Id}", model);
        ...
        //    var response = await _httpClient.PutAsJsonAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Spending/EditSpending/{model.Id}", model);
        ...
        //    try
        //    {
        //        var userInfo = await _httpClient.GetFromJsonAsync<SpendingViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/AppUser/GetUserInfo/{userName}");
