...
namespace BESMIK.SM.Areas.Personal.Controllers
{
    ...
    public class AdvanceController : Controller
    {
        ...
        public async Task<IActionResult> AdvancesList()
        {
            ...
            var advances = await _httpClient.GetFromJsonAsync<List<AdvanceViewModel>>($"https://besmikapi20240825115620.azurewebsites.net/api/Advance/AdvancesList/{userId}");
        ...
        public async Task<IActionResult> AdvanceAdd(AdvanceViewModel model)
        {
            try
            {
                ...
                var userResponse = await _httpClient.GetFromJsonAsync<AppUserViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/Advance/GetUser/{userId}");
                ...
                var response = await _httpClient.PostAsJsonAsync("https://besmikapi20240825115620.azurewebsites.net/api/Advance/AddAdvance", model);
        ...
        public async Task<IActionResult> DeleteAdvance(int id)
        {
            try
            {
                var response = await _httpClient.DeleteAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Advance/DeleteAdvance/{id}");
        ...
        {
            var response = await _httpClient.GetAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Advance/GetAdvance/{id}");
        ...
        public async Task<IActionResult> AdvanceEdit(AdvanceViewModel model)
        {
            ...
            var response = await _httpClient.PutAsJsonAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Advance/EditAdvance/{model.Id}", model);
