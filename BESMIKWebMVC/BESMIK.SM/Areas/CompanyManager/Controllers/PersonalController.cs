...
namespace BESMIK.SM.Areas.CompanyManager.Controllers
{
    ...
    public class PersonalController : Controller
    {
        ...
        public async Task<IActionResult> PersonalList()
        {
            ...
            return View(await _httpClient.GetFromJsonAsync<List<AppUserViewModel>>($"https://besmikapi20240825115620.azurewebsites.net/api/PersonalAddList/PersonalList/{request.CompanyId}"));
        }
        ...
        {
            var user = HttpContext.User.Identity.Name;
            var userResponse = await _httpClient.GetFromJsonAsync<AppUserViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/UserInfo/GetUserInfo/{user}");
            ...
            try
            {
                ...
                var response = await _httpClient.PostAsJsonAsync("https://besmikapi20240825115620.azurewebsites.net/api/PersonalAddList/PersonalAdd", model);
        ...
        public async Task<IActionResult> ValidationEmail(string usermail, string token, string returnUrl)
        {
            ...
            var apiUrl = $"https://besmikapi20240825115620.azurewebsites.net/api/PersonalAddList/ValidationEmail?usermail={usermail}&token={token}";
