...
namespace BESMIK.SM.Areas.CompanyManager.Controllers
{
    ...
    public class PermissionManagerController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var appUser = await _httpClient.GetFromJsonAsync<AppUserViewModel>("https://besmikapi20240825115620.azurewebsites.net/api/AppUser/GetUserInfo/" + user);
            var companyId = appUser.CompanyId;

            return View(await _httpClient.GetFromJsonAsync<PermissionViewModel>("https://besmikapi20240825115620.azurewebsites.net/api/Permission/PermissionListByCompanyId/" + companyId));
        }
        public async Task<IActionResult> PermissionListByCompanyId()
        {
            ...
            var permissionList = await _httpClient.GetFromJsonAsync<IEnumerable<PermissionViewModel>>("https://besmikapi20240825115620.azurewebsites.net/api/Permission/PermissionListByCompanyId/" + companyId);
        ...
        public async Task<IActionResult> Details(int id)//permissionid
        {
            try
            {
                var response = await _httpClient.GetAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Permission/GetPermission/{id}");
                ...
                var userInfo = await _httpClient.GetFromJsonAsync<AppUserViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/Advance/GetUser/{appUserId}");
        ...
        public async Task<IActionResult> PermissionApprove(PermissionViewModel model)
        {
            ...
            var result = await _httpClient.GetAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Permission/GetPermission/{permissionID}");
            ...
            var response = await _httpClient.PutAsJsonAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Permission/PermissionEdit/{model.Id}", model);
