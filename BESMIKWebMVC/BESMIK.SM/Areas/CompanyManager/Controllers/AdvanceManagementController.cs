...
namespace BESMIK.SM.Areas.CompanyManager.Controllers
{
    ...
    public class AdvanceManagementController : Controller
    {
        ...
        public async Task<IActionResult> AdvancesList()
        {
            ...
            var advancesList = await _httpClient.GetFromJsonAsync<IEnumerable<AdvanceViewModel>>("https://besmikapi20240825115620.azurewebsites.net/api/AdvanceManagement/AdvanceListByCompanyId/" + companyId);
        ...
        public async Task<IActionResult> AdvanceEdit(AdvanceViewModel model)
        {
            ...
            var response = await _httpClient.PutAsJsonAsync($"https://besmikapi20240825115620.azurewebsites.net/api/AdvanceManagement/EditAdvance/{model.Id}", model);
