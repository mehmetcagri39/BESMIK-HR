...
namespace BESMIK.SM.Areas.CompanyManager.Controllers
{
    ...
    public class SpendingManagementController : Controller
    {
        ...
        public async Task<IActionResult> SpendingManagementList()
        {
            ...
            var spendingManagemenList = await _httpClient.GetFromJsonAsync<IEnumerable<SpendingViewModel>>("https://besmikapi20240825115620.azurewebsites.net/api/SpendingManagement/SpendingListForManager/" + companyId);
        ...
        {
            var response = await _httpClient.GetAsync("https://besmikapi20240825115620.azurewebsites.net/api/SpendingManagement/GetSpending/" + id);
            ...
            var userInfo = await _httpClient.GetFromJsonAsync<AppUserViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/SpendingManagement/GetUser/{appUserId}");
        ...
        public async Task<IActionResult> SpendingManagementDetails(SpendingViewModel model)
        {
            ...
            var result = await _httpClient.GetAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Spending/GetSpending/{spendingID}");
            ...
            var response = await _httpClient.PutAsJsonAsync($"https://besmikapi20240825115620.azurewebsites.net/api/SpendingManagement/EditSpending/{model.Id}", model);
