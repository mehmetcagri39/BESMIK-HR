...
namespace BESMIK.SM.Validations
{
    public class AdvanceViewModelValidator : AbstractValidator<AdvanceViewModel>
    {
        ...
        {
            var salaryResponse = await _httpClient.GetFromJsonAsync<AppUserViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/Advance/GetUser/{model.AppUserId}", cancellationToken);
