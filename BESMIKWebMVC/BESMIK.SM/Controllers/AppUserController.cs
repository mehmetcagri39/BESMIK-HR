...
namespace BESMIK.SM.Controllers
{
    ...
    public class AppUserController : Controller
    {
        ...
        public async Task<IActionResult> Edit()
        {
            ...
            try
            {
                var userInfo = await _httpClient.GetFromJsonAsync<AppUserViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/AppUser/GetUserInfo/{userName}");
        ...
        public async Task<IActionResult> Edit(AppUserViewModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClient.PutAsJsonAsync<AppUserViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/AppUser/Guncelle/{user}", model);
