...
namespace BESMIK.SM.Controllers
{
    ...
    public class CompanyManagerController : Controller
    {
        ...
        {
            return View(await _httpClient.GetFromJsonAsync<List<AppUserViewModel>>("https://besmikapi20240825115620.azurewebsites.net/api/CompanyManager/CompanyManagerList"));
        }
