...
namespace BESMIK.SM.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            //https://besmikapi20240825115620.azurewebsites.net/api/Account/SignIn  https://besmikapi20240825115620.azurewebsites.net/api/Account/Logout
            return View();
        }
        ...
        public async Task<IActionResult> Login(string email, string password)
        {
            ...
            httpClient.BaseAddress = new Uri("https://besmikapi20240825115620.azurewebsites.net/"); //Api url
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            try
            {
                var response = await _httpClient.PostAsync("https://besmikapi20240825115620.azurewebsites.net/api/Account/Logout", null);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var response = await _httpClient.GetAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Account/ForgotPassword/{model.Email}");
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordModel model)
        {
            ...
            var user = await _httpClient.GetFromJsonAsync<AppUserViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/Account/FindUser/{model.Email}");
            ...
            var result = await _httpClient.PostAsJsonAsync($"https://besmikapi20240825115620.azurewebsites.net/api/Account/ResetPassword", model);
