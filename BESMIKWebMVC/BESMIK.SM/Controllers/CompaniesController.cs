...
namespace BESMIK.SM.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        {
            var companies = await _httpClient.GetFromJsonAsync<List<CompanyViewModel>>("https://besmikapi20240825115620.azurewebsites.net/api/Company/CompanyList");
        ...
        //{
        //    return View(await _httpClient.GetFromJsonAsync<List<CompanyViewModel>>("https://besmikapi20240825115620.azurewebsites.net/api/Company/CompanyList"));
        //}
        [HttpGet("{id}")]
        public async Task<IActionResult> CompanyDetails(int id)
        {
            var company = await _httpClient.GetFromJsonAsync<CompanyViewModel>($"https://besmikapi20240825115620.azurewebsites.net/api/Company/{id}");
            if (company == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> CompanyAdd(CompanyViewModel model)
        {
            try
            {
                ...
                var response = await _httpClient.PostAsJsonAsync("https://besmikapi20240825115620.azurewebsites.net/api/Company/AddCompany", model);
